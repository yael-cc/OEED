...
{
    public class InscripcionOController : Controller
    {
        private readonly EventosInstitucionalesContext _context;

        public InscripcionOController(EventosInstitucionalesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> CreateGO(int idEvento, int idUsuario)
        {
            ...
            if (usuarioOrganizadorExistente != null)
            {
                ...
                return RedirectToAction("IndexGO", "InscripcionO", new { id = idEvento });
            }
